//
//  FinalSetRuleTableViewController.swift
//  ScoreBoard
//
...
protocol FinalSetRuleTableViewControllerDelegate {
    func setFinalSetRule(controller: FinalSetRuleTableViewController, finalSetRule: Int)
}

class FinalSetRuleTableViewController: UITableViewController {
    ...
    var delegate: FinalSetRuleTableViewControllerDelegate?
    ...
    override func viewDidAppear(animated: Bool) {
        let indexPath: NSIndexPath = NSIndexPath(forRow: finalSetRule, inSection: 0)
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if let delegate = delegate {
            delegate.setFinalSetRule(self, finalSetRule: indexPath.row)
        }
